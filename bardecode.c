...
#define PHP_BARDECODE_REGISTER_CONST_LONG(const_name, value) \
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("IF_WARNINGS", ST_TIF_WARNINGS);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("IFF_SPLIT", ST_TIFF_SPLIT);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("HOW_CHECK_DIGIT", ST_SHOW_CHECK_DIGIT);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("IFF_SPLIT_MODE", ST_TIFF_SPLIT_MODE);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("KEW_SETTING", ST_SKEW_SETTING);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("KEW_LINE_JUMP", ST_SKEW_LINE_JUMP);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("HORT_CODE128_MIN_LENGTH", ST_SHORT_CODE128_MIN_LENGTH);
	...
	PHP_BARDECODE_REGISTER_CONST_LONG("HOW_CODABAR_START_STOP", ST_SHOW_CODABAR_START_STOP);
